...
const emojiUrl = (codePoint) => {
  ...
  return `https://noto-emoji.bendaha.eu.org/png/128/emoji_u${cp}.png`;
  return `https://noto-emoji.bendaha.eu.org/svg/emoji_u${cp}.svg`
}
...
const mixmojiUrl = (r, c) => {
  ...
  return `https://wsrv.nl/?url=https://www.gstatic.com/android/keyboard/emojikitchen/${r}/u${c[0]}/u${c[0]}_u${c[1]}.png`
}
